...
%---------------------------------------------------------
  \cventry
    ...
    {
      \begin{cvitems} 
        \item{Kept microservices running smoothly and scaling efficiently to optimize the watching experience for over \textbf{50 million DAU}.}
        \item {Designed and delivered features for the biweekly iteration of our video APP, "Xigua Video", collaborating with PM and UX}  
      ...
      %   % \item {Constantly refactored legacy systems with \textbf{Golang} to improve utilization of the CPU and memory resource and reduce human maintaining costs.}
        \item {Leverage product metrics ,data warehouses, A/B Test to exploit product potentials.}
      \end{cvitems}
    }
    %\vspace{-0.5cm}
%---------------------------------------------------------
