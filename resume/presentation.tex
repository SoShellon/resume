...
%---------------------------------------------------------
  % \cventrynew
  %   {}
  %   {Launched A Cross-Platform TV Video APP} % Event
  %   {ByteDance} % Location
  %   {}
  %   {
  %     % \begin{cvitems} 
  %     %   % \item {Designed and implemented microservices from scratch within 1 month.} %Daily active users increased from 0 to \textbf{50000+} within the first 3 months after deploying online.}
...
%---------------------------------------------------------
  \cventrynew
    {Role: Developer and Team Leader} % Job title
